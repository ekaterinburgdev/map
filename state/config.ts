...
export const defaultLayers: InputSloyLayer[] = [
    ...
    },
    {
        ...
        description:
            '«Данная карта — это попытка систематизировать всё, что я знаю об уличном искусстве Екатеринбурга. Всего на карте более 700 отметок (к каждой прилагается фото) — это сохранившиеся работы, происхождение которых мне известно (кто автор, год создания, в рамках какого фестиваля или личная инициатива художника). Вы можете использовать эту карту, чтобы, например, спланировать маршрут прогулки по городу, но имейте в виду, что какие-то работы уже исчезли (о чём я не знал) или могут исчезнуть в любой момент». Дата последнего обновления данных: 25 Августа 2024',
        link: {
