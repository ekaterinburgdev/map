    ...
    return (
        <>
            <div className={styles.aboutProjectIcons}>
                ...
                <Button text="О проекте" type={ButtonType.BLACK} paddings={ButtonPaddings.SMALL} onClick={open} />
                <Button text="Фидбек" type={ButtonType.YELLOW} paddings={ButtonPaddings.SMALL} onClick={() => {}} link="https://tally.so#tally-open=wLzxEG&tally-width=650&tally-overlay=1&tally-emoji-animation=none" />
            </div>
        </>
    );
}
