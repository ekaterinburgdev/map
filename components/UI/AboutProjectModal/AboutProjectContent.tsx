...
export function AboutProjectContent() {
    return (
        <article className={styles.aboutProjectModal__content}>
            ...
            <p>Все источники перечислены ниже, а&nbsp;используемые данные доступны <a href="https://github.com/ekaterinburgdev/map#map-data" target="_blank" rel="noreferrer">в&nbsp;репозитории</a>.</p>
